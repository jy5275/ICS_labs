...
bool instr_valid = icode in 
	{ INOP, IHALT, IRRMOVL, IIRMOVL, IRMMOVL, IMRMOVL,
	       IOPL, IJXX, ICALL, IRET, IPUSHL, IPOPL,IIADDL,ILEAVE };  # altered for IIADDL, ILEAVE
...
bool need_valC =
	icode in { IIRMOVL, IRMMOVL, IMRMOVL, IJXX, ICALL,IIADDL };   # altered for IIADDL
...
int srcA = [
	...
	icode in { ILEAVE } : REBP;        # add a line for instrction ILEAVE
	1 : RNONE; # Don't need register
];

## What register should be used as the B source?
int srcB = [
	icode in { IOPL, IRMMOVL, IMRMOVL, IIADDL } : rB;    # altered for IIADDL
...
int dstE = [
	...
	icode in { IIRMOVL, IOPL, IIADDL } : rB;    # altered for IIADDL
	icode in { IPUSHL, IPOPL, ICALL, IRET } : RESP;
	icode in { ILEAVE } : RESP;        # add a line for instrction ILEAVE
...
int aluA = [
	...
	icode in { IIRMOVL, IRMMOVL, IMRMOVL, IIADDL } : valC;   # altered for IIADDL
	icode in { ICALL, IPUSHL } : -4;
	icode in { IRET, IPOPL, ILEAVE } : 4;       # altered for instruction ILEAVE
...
int aluB = [
	icode in { IRMMOVL, IMRMOVL, IOPL, ICALL, 
		      IPUSHL, IRET, IPOPL, IIADDL, ILEAVE } : valB;     # altered for IIADDL && ILEAVE
...
int alufun = [
	icode == IOPL : ifun;
	1 : ALUADD;               # ILEAVE && IIADDL fall into this line
];

## Should the condition codes be updated?
bool set_cc = icode in { IOPL, IIADDL };   # altered for IIADDL

################ Memory Stage    ###################################

## Set read control signal
bool mem_read = icode in { IMRMOVL, IPOPL, IRET, ILEAVE };      # altered for ILEAVE
...
int mem_addr = [
	...
	icode in { IPOPL, IRET, ILEAVE } : valA;    # altered for ILEAVE
